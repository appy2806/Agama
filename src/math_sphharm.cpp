...
// legendrePmm and sphHarmArray moved to math_sphharm.h as AGAMA_DEVICE_INLINE
// free functions (Tier 0 Legendre helpers, 2026-07): both write only into
// caller-provided arrays, so they are device-callable as-is. The GSL-backed
// m > LEGENDRE_MMAX normalization fallback stays host-only there.
