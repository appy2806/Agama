...
// evalCubicSplines<K> and evalQuinticSplines<K> (the piecewise-polynomial cores shared by every
// 1d/2d/3d cubic and quintic spline evaluator in this file -- CubicSpline, QuinticSpline,
// CubicSpline2d, QuinticSpline2d and CubicSpline3d all call them) moved to math_spline.h as
// AGAMA_DEVICE_INLINE template free functions (Tier 0), so device kernels can call the same
// leaf math directly in upcoming Tier 2 (Multipole/CylSpline) work without duplicating it here.
